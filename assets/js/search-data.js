...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
    ...
    },{id: "news-i-gave-a-keynote-at-icccn-2024",
          title: 'I gave a keynote at ICCCN 2024.',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/announcement_4/";
            },},{id: "news-i-gave-a-seminar-talk-at-the-ece-department-of-purdue-university",
          title: 'I gave a seminar talk at the ECE department of Purdue University.',
          description: "",
          section: "News",},{id: "news-i-served-as-a-tpc-co-chair-for-itw-2024",
          ...
          description: "",
          section: "News",},{id: "news-the-ruth-and-joel-spria-teaching-award",
          title: 'The Ruth and Joel Spria Teaching Award',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/announcement_9/";
            },},{id: "news-visiting-hkust",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6C%69%7A%68%6F%6E%67@%6D%69%74.%65%64%75", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/lizhong-zheng-aa671613", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Wul8NAQAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
