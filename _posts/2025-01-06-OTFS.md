...
&= \frac{\sqrt{M}}{\sqrt{NT}} \cdot \sum_{n=0}^{N-1} \mathrm{sinc}\left( \frac{M}{T} \cdot t - l - nM \right) \cdot e^{j\pi (\frac{M}{T}\cdot t - l - nM)}\cdot e^{j2\pi \frac{kn}{N}} \\
& \approx \frac{1}{\sqrt{N}} \cdot \sum_{n=0}^{N-1} g\left(t - l - nM; \frac{T}{M}\right) \cdot e^{j\pi (\frac{M}{T}\cdot t - l - nM)}\cdot e^{j2\pi \frac{kn}{N}}\\
