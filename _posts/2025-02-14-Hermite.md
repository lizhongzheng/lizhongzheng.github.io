...
Theorem: Orthogonal Multi-Variate Polynomial Basis
: For $\Sigma$ defined above, the set of functions $\phi_{ij} (x_1, x_2; \Sigma)$ in the following form is an ortho-normal set. 

$$\phi_{ij}(x_1, x_2; \Sigma) \stackrel{\Delta}{=} \phi_i(x_1; 0, 1) \cdot \phi_j(x_2; \rho x_1, 1-\rho^2)$$
