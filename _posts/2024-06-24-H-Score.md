...
where in (2) we evaluated the inner product and norm with respect to the reference distribution \(R*{\mathsf{xy}} = P*{\mathsf{x}} P*{\mathsf{y}}\), and in (3) we used the local approximation$$\mathrm{PMI} \approx \frac{P*{\mathsf{xy}}}{P*{\mathsf{x}}P*{\mathsf{y}}} -1$$.
